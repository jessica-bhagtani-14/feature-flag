// frontend/src/pages/CreateRule.jsx
...
const CreateRule = () => {
  ...
  const { app_id, flag_id } = useParams();

  console.log('URL Params:', { app_id, flag_id });
  ...
  const createMutation = useMutation({
    mutationFn: (data) => {
        ...
        console.log('Using IDs:', { appId, flagId });
        
        if (!appId || !flagId) {
          throw new Error('Missing app_id or flag_id');
        }
        ...
        return flagService.createFlagRule(appId, flagId, ruleData);
      },
    onSuccess: () => {
  ...
  const handleTypeChange = (e) => {
    ...
    setFormData(prev => ({
      ...prev,
      type: newType,
      target_percentage: newType === 'conditional' ? 100 : ''
    }));
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Add a new rule to your feature flag</p>
          </div>
        </div>
      </div>
